...
class DataProcessor{
    ...
    public:
        ...
        void ChangeFileSwitch(const Student &student, const string &UcCodeToChange, const string &newClassCode);
        void ChangeFileRemove(const Student &student, const string &UcCodeToRemove);
        void ChangeFileAdd(const Student &student, const string &NewClassCode, const string &NewUcCode);
        ...
        void SwitchRequest(const Student &student, const string &oldClassCode, const string &newClassCode, const string &UcCode,bool save);
        void RemoveRequest(const Student &student, const string &UcCode, bool save);
        void AddRequest(const Student &student, const string &UcCode, bool save);
